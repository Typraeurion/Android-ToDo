...
import static com.xmission.trevin.android.todo.provider.ToDoSchema.ToDoItemColumns.REPEAT_WEEK_AFTER;
 ...
 * week after its last completion (within the constraints of
 * the available days of the week).
 *
 * @author Trevin Beattie
 */
public class RepeatWeekAfter extends AbstractAdjustableRepeat {

    private static final long serialVersionUID = 4;

    public static final int ID = REPEAT_WEEK_AFTER;
    ...
    /**
     * Create a default RepeatWeekAfter object for a given due date.
    ...
    public LocalDate computeNextDueDate(
        ...
        LocalDate candiDate = adjustDueDate(
                completed.plusWeeks(tentativeIncrement));
    ...
    public String toString() {
        ...
        if (increment > 1) {
            ...
            sb.append(" week after completion");
        } else {
            sb.append("The next week after completion");
        }
        formatDays(sb);
        if (end != null) {
    ...
    @Override
    @NonNull
    public RepeatWeekAfter clone() {
        return (RepeatWeekAfter) super.clone();
    }
    ...
    public boolean equals(Object o) {
        if (!super.equals(o))
            return false;
        if (!(o instanceof RepeatWeekAfter))
            return false;
        return true;
    }
